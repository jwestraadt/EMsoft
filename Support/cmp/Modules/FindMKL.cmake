...
if(NOT "${CMAKE_Fortran_COMPILER}" STREQUAL "")
    ...
    get_filename_component(INTEL_FORTRAN_ROOT_DIR ${INTEL_FORTRAN_BIN_DIR} DIRECTORY)
    set(INTEL_FORTRAN_LIB_DIR "${INTEL_FORTRAN_ROOT_DIR}/lib")
endif()
...
if(NOT "$ENV{MKLROOT}" STREQUAL "")
    set(MKL_INCLUDE_SEARCH_DIRS ${MKL_INCLUDE_SEARCH_DIRS} $ENV{MKLROOT}/include)
endif()
...
if(NOT "${MKL_DIR}" STREQUAL "")
    set(MKL_INCLUDE_SEARCH_DIRS ${MKL_INCLUDE_SEARCH_DIRS} "${MKL_DIR}/include" "${MKL_DIR}")
endif()
...
if(NOT "$ENV{MKLROOT}" STREQUAL "")
    set(MKL_INCLUDE_SEARCH_DIRS ${MKL_INCLUDE_SEARCH_DIRS} $ENV{MKLROOT}/include/fftw)
endif()
if(NOT "${IFORT_COMPILER_ROOT_DIR}" STREQUAL "")
    set(MKL_INCLUDE_SEARCH_DIRS ${MKL_INCLUDE_SEARCH_DIRS} "${IFORT_COMPILER_ROOT_DIR}/mkl/include/fftw")
endif()
if(NOT "${MKL_DIR}" STREQUAL "")
    set(MKL_INCLUDE_SEARCH_DIRS ${MKL_INCLUDE_SEARCH_DIRS} "${MKL_DIR}/include/fftw" "${MKL_DIR}/include")
endif()
# message(STATUS "MKL_INCLUDE_SEARCH_DIRS: ${MKL_INCLUDE_SEARCH_DIRS}")      
...
set(MKL_LIB_DIRS "")
if(EXISTS "${MKL_LIB_DIR}")
    list(APPEND MKL_LIB_DIRS "${MKL_LIB_DIR}")
endif()
if(EXISTS "${MKL_LIB_DIR}/${MKL_ARCH_DIR}")
    list(APPEND MKL_LIB_DIRS "${MKL_LIB_DIR}/${MKL_ARCH_DIR}")
endif()
if(NOT "${IFORT_COMPILER_ROOT_DIR}" STREQUAL "")
    if(NOT APPLE)
        get_filename_component(IFORT_COMPILER_ROOT_DIR ${IFORT_COMPILER_ROOT_DIR} DIRECTORY)
...
if(NOT "${INTEL_FORTRAN_LIB_DIR}" STREQUAL "" AND EXISTS "${INTEL_FORTRAN_LIB_DIR}")
    list(APPEND MKL_LIB_DIRS "${INTEL_FORTRAN_LIB_DIR}")
endif()
if(NOT "${IFORT_COMPILER_ROOT_DIR}" STREQUAL "")
    if(EXISTS "${IFORT_COMPILER_ROOT_DIR}/lib")
        list(APPEND MKL_LIB_DIRS "${IFORT_COMPILER_ROOT_DIR}/lib")
    endif()
    if(EXISTS "${IFORT_COMPILER_ROOT_DIR}/redist/${MKL_ARCH_DIR}/compiler")
        list(APPEND MKL_LIB_DIRS "${IFORT_COMPILER_ROOT_DIR}/redist/${MKL_ARCH_DIR}/compiler")
    endif()
endif()
...
if(WIN32)
    unset(MKL_${MKL_OpenMP_Library}_LIBRARY CACHE)
    find_library(MKL_${MKL_OpenMP_Library}_LIBRARY
        NAMES lib${MKL_OpenMP_Library}md ${MKL_OpenMP_Library}md lib${MKL_OpenMP_Library} ${MKL_OpenMP_Library}
        PATHS ${INTEL_FORTRAN_LIB_DIR} ${INTEL_FORTRAN_BIN_DIR}
    )
    if(MKL_${MKL_OpenMP_Library}_LIBRARY)
        set(MKL_LIBRARIES ${MKL_LIBRARIES} ${MKL_${MKL_OpenMP_Library}_LIBRARY})
    endif()
else()
    set(MKL_LIB_PREFIX ${CMAKE_SHARED_LIBRARY_PREFIX})
    set(MKL_LIB_SUFFIX ${CMAKE_SHARED_LIBRARY_SUFFIX})
